...
//                        resultPassed += _.minBy(grouped, 'passed').passed;
                    ...
                    return (
                        <a key={panel.id} className="table__row" href={`/panel/${panel.id}/${this.props.version.id}`}>
                            ...
                            <div className="table__cell">{resultFail}</div>
                            <div className="table__cell">{failurePercent} %</div>
            ...
            <div>
                <div className="table">
                    <div className="table__row">
                        ...
                        <div className="table__cell table__cell_type_header">Percent failure</div>
